...
| shaintha   | Scrum Master / Developer                    | Organization of team meetings, Ensure team communication  | Pong Game mechanics, Canvas rendering, Game physics | > clean and smooth game rendering via canvas drawing<br> - game physics (consistent ball velocity and collision zones with player paddles)<br> > proper entity collisions and checks before each movement<br> - design of user interface of the game associated pages<br> > usage of GridCards, Dialogues and tables |
