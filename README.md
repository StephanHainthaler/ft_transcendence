...
| **Gaming**           |                           |                    |                 |         |            |            |                           |
| `-`                  | Web-based game            | - [Canvas API](https://developer.mozilla.org/en-US/docs/Web/API/Canvas_API)<br> - [WebSocket](https://websocket.org/reference/websocket-api/) | shaintha & juitz| Major   | 2          | simple 2-player implementation of a PONG game with setable score & duration        |  - Canvas is the standard way to draw games in browsers<br> -  WebSocket keeps the game smooth for both players |
