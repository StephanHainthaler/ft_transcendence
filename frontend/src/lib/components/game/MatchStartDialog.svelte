                    ...
                    <div class="flex items-center gap-3 mb-3 last:mb-0">
                        ...
                        <p class="text-sm text-white/80 leading-relaxed">
                            {@html v
                                ...
                                .replace(/Up\/Down arrows|стрілки Вгору\/Вниз|Pfeiltasten Oben\/Unten/gi, '<b class="text-white bg-white/10 px-1 rounded">↑/↓</b>')
                            }
                            {#if v.includes('past your opponent')}
                                <MoveVertical class="inline-block size-3 text-chart-3 ml-1" />
                            {/if}
                        </p>
                    </div>
                {/each}
